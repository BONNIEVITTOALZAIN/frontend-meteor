...
const Kelas = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editMode) {
        await api.put(`/admin/kelas/${currentKelas.id}`, formData);
        Swal.fire("Berhasil!", "Data kelas telah diperbarui.", "success");
      } else {
        await api.post("/admin/kelas", formData);
        Swal.fire("Berhasil!", "Data kelas telah ditambahkan.", "success");
      }
  ...
  const currentItems = filteredKelas.slice(indexOfFirst, indexOfLast);
